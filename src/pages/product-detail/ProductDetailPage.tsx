  ...
  return (
    <div className="min-h-screen bg-white font-sans antialiased">
      ...
      <div className="relative bg-gradient-to-r from-[#F5EFE7] via-[#EDE0D0] to-[#F0E6DA] border-b border-[#E8DDD0] overflow-hidden">
        ...
        <div className="absolute right-10 bottom-0 w-32 h-[120%] rounded-t-full border border-[#9A7A46]/12 hidden lg:block" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 md:py-6">
          ...
          <p className="text-[10px] tracking-[0.3em] uppercase text-[#9A7A46]/60 font-medium">
            {isLoading
              ? "Loading product…"
              : isError
                ? "Product not found"
