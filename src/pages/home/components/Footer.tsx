  ...
  <footer className="bg-[#100C07] text-white">
    <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-16 pt-14 pb-8">
        ...
        <div className="col-span-2 md:col-span-2">
          ...
          <div className="mt-7 space-y-2.5">
            {[
              ...
              { Icon: Phone, text: "+91 9972829912", href: "tel:+919972829912" },
              { Icon: MessageCircle, text: "+91 8548995696", href: "https://wa.me/918548995696" },
              { Icon: Mail, text: "shadesoriginals.info@gmail.com", href: "mailto:shadesoriginals.info@gmail.com" },
              { Icon: ClockAlert, text: "Support Hours: 10 AM - 6.30 PM", href: undefined },
            ].map(({ Icon, text, href }) => (
              <div key={text} className="flex items-start gap-2.5">
                <Icon size={13} className="text-[#C6A46C] mt-0.5 shrink-0" />
                {href ? (
                  <a href={href} target={href.startsWith("http") ? "_blank" : undefined} rel={href.startsWith("http") ? "noopener noreferrer" : undefined} className="text-xs text-gray-500 tracking-wide hover:text-[#C6A46C] transition-colors">
                    {text}
                  </a>
                ) : (
      ...
      <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <p className="text-[10px] tracking-[0.3em] uppercase text-[#C6A46C]/90">
